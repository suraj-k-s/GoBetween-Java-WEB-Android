...
<html>
    ...
    <%        if (request.getParameter("btn_send") != null) {
            String insQry = "insert into tbl_transport_request (delivery_time,delivery_date,transport_request_date,transport_request_for_date,transport_request_description,transport_request_qty,from_location_id,to_location_id,company_id,category_id,user_id)"
                    + " values('" + request.getParameter("time_delivery") + "','" + request.getParameter("date_del") + "',curdate(),'" + request.getParameter("date_for") + "','" + request.getParameter("txt_desc") + "','" + request.getParameter("txt_qty") + "','" + request.getParameter("sel_location") + "','" + request.getParameter("sel_location1") + "','" + request.getParameter("cid") + "','" + request.getParameter("sel_cat") + "','" + session.getAttribute("uid") + "')";
